                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="padding-top: 10px;">
                        <div class="right-content">
                            <form>
                                <center><div><h1 style="border-bottom: 1px solid rgb(58,139,205)">My Profile</h1></div></center>
                                <div class="if">Username: ${sessionScope.account.username}</div>
                                <div class="if">Name: ${sessionScope.user.name}</div>
                                <div class="if">Phone Number: ${sessionScope.user.phone}</div>
                                <div class="if">Address: ${sessionScope.user.address}</div>
                                <div class="if">Email: ${sessionScope.user.email}</div>
                                <div style="margin-top: 50px"></div>
                                <center>
                                    <a href="changeinfor.jsp" style="padding: 10px 20px; background-color: rgb(58,139,205); color: #fff; border-radius: 10px">Change Information</a>
                                </center>
                            </form>
                        </div>
                    </div>
