...
//        String user =request.getParameter("user");
        ...
        User_HE164042 z= (User_HE164042) session.getAttribute("user");
        UserDAO ud = new UserDAO();
        AccountDAO a= new AccountDAO();
//        int id = a.check(user);
        ud.update(z.getId(), name, phone, address);
        request.setAttribute("mess", "Changed Information");
//        session.removeAttribute("user");
        session.setAttribute("user", ud.getUser(z.getId()));
