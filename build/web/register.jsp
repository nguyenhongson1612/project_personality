<%-- 
    Document   : login
    Created on : Oct 25, 2022, 7:54:47 AM
    Author     : ADMIN
--%>
...
<html lang="en" >
    ...
    <body>
        ...
        <form action="register" method="post">
            ...
            <div class="form-field">
                <button class="btn" type="submit">Creat a new account</button>
            </div>

            <div class="form-field">
                <a href="login" style="text-decoration: none; margin-left: 98px">Already have account?</a>
            </div>
        </form>
        <!-- partial -->
